...
export function Astronauts(props) {
  ...
  //Use Effect function to run a script {} when ever we have this value == ySpring
  useEffect(() => {
    ySpring.set(-1);
  }, [ySpring]);
  ...
  return (
    <group
      ref={group}
      {...props}
      rotation={[-Math.PI / 2, -0.2, 2.1]}
      scale={props.scale || 0.28} // if it doesn't have a scale prop, it will default to 0.3
      position={props.position || [2.5, -1, 0]} // if it doesn't have a position prop, it will default to [0, -1.5, 0]
    >
